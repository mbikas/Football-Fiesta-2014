 ...
 * @author  Bikas
 */
public final class TableButtonField extends Field
{
    /**
     ...
     */
    public static final int DEFAULT_FONT_HEIGHT = 15;
     ...
     */
    public final static int DEFAULT_LEFT_MARGIN =  1;
    public final static int DEFAULT_RIGHT_MARGIN = 1;
     ...
     */
    public final static int DEFAULT_LEFT_PADDING = 1;
    public final static int DEFAULT_RIGHT_PADDING = 1;
     ...
     */
    public TableButtonField(final String label)
    {
        this(label, false);
    }
     ...
     */
    public TableButtonField(final String label, boolean isFullScreenWide)
    {
     ...
     * @param isFullScreen Indicates whether the button will be wide to display screen
     */
    public TableButtonField(final String label, Font font, boolean isFullScreenWide)
    {
        // Let the super class handle its own chores.
        super();
     ...
     * @param label     Text label of the button
     */
    public TableButtonField(final EncodedImage iconNormal, final String label, boolean isFullScreenWide)
    {
        super();
     ...
     * @param label     Text label of the button
     */
    public TableButtonField(final EncodedImage iconNormal, final String label, boolean isFullScreenWide, Font font)
    {
        super();
     ...
     * @param label     Text label of the button
     */
    public TableButtonField(final Bitmap iconNormal, final String label, boolean isFullScreenWide)
    {
        super();
     ...
     * @param label                     Text label of the button
     */
    public TableButtonField(final EncodedImage backgroundImageNormal, final EncodedImage backgroundImageOnFocus, final String label)
    {
        this(backgroundImageNormal, backgroundImageOnFocus, null, label, false);
    }
    
    public TableButtonField(final EncodedImage backgroundImageNormal, final EncodedImage backgroundImageOnFocus, final String label, Font font)
    {
        this(backgroundImageNormal, backgroundImageOnFocus, null, label, false, font);
    }
    
    
    public TableButtonField(final int backgroundColorNormal, final int backgroundImageOnFocus, final String label, final boolean isFullScreenWide, Font font)
    {
    ...
    public TableButtonField(final int backgroundColorNormal, final int backgroundImageOnFocus, final String label, final boolean isFullScreenWide)
    {
     ...
     */
    public TableButtonField(final EncodedImage backgroundImageNormal, final EncodedImage backgroundImageOnFocus, final String label, boolean isFullScreenWide)
    {
     ...
     * @param isFullScreenWide          Indicates whether the button will be wide to display screen
     */
    public TableButtonField(final EncodedImage backgroundImageNormal, final EncodedImage backgroundImageOnFocus, 
    ...
    private int width3 = 20;
    private int width4 = 20;
    public void setWidths(int width1, int width2, int width3, int width4)
    {
        this.width1 = width1;
        this.width2 = width2;
        this.width3 = width3;
        this.width4 = width4;
        this.width = width1 + width2 + width3 + width4;
    }
    ...
    public void setLabels(String text1, String text2, String text3, String text4)
    {
        this.text1 = text1;
        this.text2 = text2;
        this.text3 = text3;
    ...
    private Bitmap imageLeft = null;
    private Bitmap imageRight = null;
    public void setLeftImage(Bitmap imageLeft)
    {
        this.imageLeft = imageLeft;
    }
    public void setRightImage(Bitmap imageRight)
    {
        ...
        if(isFocus() == false) // normal
        {
            ...
            else
            {
                ...
                if (position == POSITION_FIRST)
                {
                        ...
                        graphics.fillRect(leftMargin, topMargin+10, w, h-10);
                }
                else if (position == ONLY_ONE)
                {
                        graphics.fillRoundRect(leftMargin, topMargin, w, h, 10, 10);
                }
                ...
                {
                        graphics.fillRoundRect(leftMargin, topMargin, w, h, 10, 10);
                        graphics.fillRect(leftMargin, topMargin, w, h-10);
            ...
            int x = labelTopLeftPoint.x + gapBetween - intialGapMinus + iconWidth;
            
            graphics.drawText(text1, x, y, DrawStyle.HCENTER, width1);
            graphics.drawLine(width1, 0, width1, this.height);
            x = x + width1;
            
            if (imageLeft != null)
            {
                graphics.drawBitmap(x,y, imageLeft.getWidth(), imageLeft.getHeight(), imageLeft, 0, 0);
                x = x + imageLeft.getWidth();
                int w2 = width2 - imageLeft.getWidth();
                graphics.drawText(text2, x, y, DrawStyle.LEFT, w2);
                graphics.drawLine(x + w2, 0, x + w2, this.height);
                x = x + w2;
            }
            else
            {
                graphics.drawText(text2, x, y, DrawStyle.HCENTER, width2);
                graphics.drawLine(x + width2, 0, x + width2, this.height);                
                x = x + width2;
            }
            
            graphics.drawText(text3, x, y, DrawStyle.HCENTER, width3);
            graphics.drawLine(x + width3, 0, x + width3, this.height);
            x = x + width3;
            
            if (imageRight != null)
            {
                int imageWidth = imageRight.getWidth();
                int w4 = width4 - imageWidth - 15;
                graphics.drawText(text4, x, y, DrawStyle.RIGHT, w4);
                graphics.drawBitmap(x + w4 + 2 , y, imageRight.getWidth(), imageRight.getHeight(), imageRight, 0, 0);
                
            }
            else
            {
                 graphics.drawText(text4, x, y, DrawStyle.HCENTER, width4);
                 //graphics.drawLine(x + width4, 0, x + width4, this.height);
            }
    ...
    private Object buttonTagObject = null;
    
    public void setTagObject( Object obj)
    {
        this.buttonTagObject = obj;
        
    }
    
    public Object getTagObject()
    {
        return this.buttonTagObject;
    }   
}
